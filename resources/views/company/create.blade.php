            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card " id="mycard-dimiss">
                        ...
                        <div class="card-body">
                            Halaman ini adalah menu Tambah Perusahaan
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('company.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control  @error('private_email') is-invalid @enderror" name="private_email" value="" placeholder="ex. private@mail.com">
                                    @error('private_email')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
