        ...
        <div class="section-body">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-12 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route(Auth::user()->role.'.warningletter.store') }}" enctype="multipart/form-data">
                                @csrf
                                ...
                                <a href="{{ route(Auth::user()->role.'.warningletter.index') }}" class="btn btn-secondary">Back</a>
                            </form>
                        </div>
                    </div>
                </div>
